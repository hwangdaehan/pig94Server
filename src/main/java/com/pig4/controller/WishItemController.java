...
public class WishItemController {
	...
	@ResponseBody
	public ResultVO insertWishItem(@ModelAttribute WishVO wishVO) {
		WishVO  result = wishItemService.save(wishVO);
	...
	@ResponseBody
	public ResultVO wishItemList() {
		List<WishVO> resultList = wishItemService.selectList();
